function ticketAlerts() {
    ...
    if(document.getElementById('ticketAmount').value > document.getElementById('tripSeats').value) {
        alert("Not enough tickets.\n Please select less or look for another trip.");
        return false;
    }else if (document.getElementById('ticketAmount').value * document.getElementById('tripCost').value
