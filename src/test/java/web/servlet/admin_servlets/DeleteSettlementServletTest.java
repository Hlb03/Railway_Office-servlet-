...
class DeleteSettlementServletTest {

    private final DeleteSettlementServlet servlet = new DeleteSettlementServlet();
    ...
    void doPostExceptionThrowingScenario() throws ServletException, IOException, DbException {
        ...
        doThrow(DbException.class).when(settlementService).deleteSettlement(settlementName);
        ...
        assertThrows(DbException.class, () -> settlementService.deleteSettlement(settlementName));
    }
    ...
    private void verifyPart() throws DbException {
        ...
        verify(settlementService, times(1)).deleteSettlement(settlementName);
    }
}